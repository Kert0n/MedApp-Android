 ...
 * `packages`, и она остаётся, когда живой строки больше нет. За неё держатся приёмы и движения
 * (`RESTRICT`), поэтому история читается с именем и единицей и после того, как коробка кончилась
 * или выброшена (PLAN D3, D6, D7, F1). Снимок имени, единицы и формы переписывается вместе с
