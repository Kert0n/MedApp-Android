...
interface MedKitStorageRepository {
     ...
     *
     * Пачка, изменившаяся или появившаяся между чтением содержимого и этой записью, значит, что
     * серверная копия уже не отражает местного: тогда не пишется ничего — `false`, публиковать
     * заново (E5).
     */
