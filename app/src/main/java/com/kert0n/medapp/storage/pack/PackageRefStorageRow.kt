...
/**
 * Пачка глазами чужого агрегата — источника курса, приёма, движения: запись о коробке, а не
 * живая строка, поэтому история читается и после того, как коробки не стало (PLAN D6, D7). Room
