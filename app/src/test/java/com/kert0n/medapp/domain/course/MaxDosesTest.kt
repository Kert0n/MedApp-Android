...
class MaxDosesTest {
    ...
    fun doseTwoOutOfTwoSinglesGivesZeroDoses() {
        ...
        assertEquals(doses(0), twoPacks(0, 0).limit(PACK, required = 14, availability = singles))
        assertEquals(
            doses(0),
            twoPacks(0, 0).limit(OTHER_PACK, required = 14, availability = singles)
        )
    }
    ...
    fun packageLimitsTheSliderWhenTheNeedIsLarger() {
        ...
        assertEquals(doses(10), twoPacks(0, 0).limit(PACK, required = 28))
        assertEquals(doses(6), twoPacks(0, 0).limit(OTHER_PACK, required = 28))
    }
    ...
    fun secondSliderIsClampedWhenTheFirstCoveredTheNeed() {
        ...
        assertEquals(doses(0), twoPacks(9, 0).limit(OTHER_PACK, required = 9))
        assertEquals(doses(4), twoPacks(5, 0).limit(OTHER_PACK, required = 9))
    }
    ...
    fun sliderOfTheSourceItselfIgnoresItsOwnAllocation() {
        ...
        assertEquals(doses(4), twoPacks(4, 5).limit(PACK, required = 9))
    }
    ...
    fun overAllocatedMedicineDoesNotProduceANegativeLimit() {
        ...
        assertEquals(doses(0), twoPacks(9, 2).limit(OTHER_PACK, required = 9))
    }
    ...
    fun unknownAvailabilityKeepsTheLastAllocation() {
        ...
        assertEquals(doses(5), twoPacks(5, 4).limit(PACK, required = 28, availability = unknown))
        assertEquals(
            doses(0),
            twoPacks(5, 0).limit(OTHER_PACK, required = 28, availability = unknown)
        )
    }
    ...
    fun fractionalRemainderNeverBecomesADose() {
        ...
        assertEquals(doses(2), twoPacks(0, 0).limit(PACK, required = 28, availability = odd))
    }
