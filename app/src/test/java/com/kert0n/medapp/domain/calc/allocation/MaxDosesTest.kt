...
class MaxDosesTest {
    ...
    fun unknownAvailabilityKeepsTheLastAllocation() {
        ...
        assertEquals(doses(5), maxDoses(PACK, stack(5, 4), requiredDoses = doses(28), availability = emptyMap()))
        assertEquals(doses(0), maxDoses(OTHER_PACK, stack(5, 0), requiredDoses = doses(28), availability = emptyMap()))
    }
